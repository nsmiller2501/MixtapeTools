...
This command lives at `.claude/skills/newproject/SKILL.md`.

To make it available in any project, copy or symlink the `.claude/skills/newproject/` directory into that project's `.claude/skills/` folder.
